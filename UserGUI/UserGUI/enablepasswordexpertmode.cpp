...
EnablePasswordExpertMode::EnablePasswordExpertMode(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::EnablePasswordExpertMode)
{
...
EnablePasswordExpertMode::~EnablePasswordExpertMode()
{
    delete ui;
}

QString EnablePasswordExpertMode::GetAuthenticationUserName()
{
    return user_name;
}

int EnablePasswordExpertMode::GetAuthenticationValue ()
{
